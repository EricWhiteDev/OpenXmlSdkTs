...
export const ContentType = {
  ...
  wordprocessingCommentsExtended: "application/vnd.microsoft.com.office.word.commentsExtended+xml",
  wordprocessingCommentsIds: "application/vnd.microsoft.com.office.word.commentsIds+xml",
  wordprocessingCommentsExtensible: "application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtensible+xml",
